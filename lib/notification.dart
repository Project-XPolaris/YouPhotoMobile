...
class NotificationPlugin {
  ...
  Future<void> showUploadNotification(String title, String body,int progress,int total) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
        'upload_channel_id', 'Upload Channel',
  ...
  Future<void> showDownloadNotification(String title, String body,int progress,int total) async {
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
        'download_channel_id', 'Download Channel',
        importance: Importance.max,
        priority: Priority.high,
        showWhen: false,
        progress: progress,
